...
{"lineNum":"   71","line":"            fn index(&self, index: ::core::ops::RangeFull) -> &[u8] {","class":"lineCov","hits":"1","order":"2212","possible_hits":"1",},
{"lineNum":"   72","line":"                &self.0[index]","class":"lineCov","hits":"1","order":"2213","possible_hits":"1",},
{"lineNum":"   73","line":"            }","class":"linePartCov","hits":"1","order":"2220","possible_hits":"2",},
{"lineNum":"   74","line":"        }"},
{"lineNum":"   75","line":"    )"},
{"lineNum":"   76","line":");"},
{"lineNum":"   77","line":""},
...
{"lineNum":"  105","line":"        fn input(&mut self, mut inp: &[u8]) {","class":"lineCov","hits":"1","order":"2349","possible_hits":"1",},
{"lineNum":"  106","line":"            while !inp.is_empty() {","class":"lineCov","hits":"3","order":"2350","possible_hits":"3",},
{"lineNum":"  107","line":"                let buf_idx = self.length % <Self as EngineTrait>::BLOCK_SIZE;","class":"lineCov","hits":"1","order":"2353","possible_hits":"1",},
{"lineNum":"  108","line":"                let rem_len = <Self as EngineTrait>::BLOCK_SIZE - buf_idx;","class":"linePartCov","hits":"1","order":"2354","possible_hits":"2",},
{"lineNum":"  109","line":"                let write_len = cmp::min(rem_len, inp.len());","class":"lineCov","hits":"1","order":"2355","possible_hits":"1",},
{"lineNum":"  110","line":""},
{"lineNum":"  111","line":"                self.buffer[buf_idx..buf_idx + write_len]","class":"linePartCov","hits":"2","order":"2362","possible_hits":"3",},
{"lineNum":"  112","line":"                    .copy_from_slice(&inp[..write_len]);","class":"lineCov","hits":"1","order":"2367","possible_hits":"1",},
{"lineNum":"  113","line":"                self.length += write_len;","class":"linePartCov","hits":"1","order":"2376","possible_hits":"3",},
{"lineNum":"  114","line":"                if self.length % <Self as EngineTrait>::BLOCK_SIZE == 0 {","class":"lineCov","hits":"2","order":"2377","possible_hits":"2",},
{"lineNum":"  115","line":"                    self.process_block();","class":"lineCov","hits":"1","order":"2378","possible_hits":"1",},
{"lineNum":"  116","line":"                }"},
{"lineNum":"  117","line":"                inp = &inp[write_len..];","class":"lineCov","hits":"1","order":"2492","possible_hits":"1",},
{"lineNum":"  118","line":"            }"},
{"lineNum":"  119","line":"        }","class":"lineCov","hits":"1","order":"2496","possible_hits":"1",},
{"lineNum":"  120","line":""},
...
var header = { "command" : "ser_de-d029ad6af9d5a7c5", "date" : "2019-08-31 07:54:50", "instrumented" : 20, "covered" : 15,};
var merged_data = [];
