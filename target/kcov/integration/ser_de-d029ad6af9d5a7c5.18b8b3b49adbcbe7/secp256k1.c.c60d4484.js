...
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"size_t secp256k1_context_preallocated_size(unsigned int flags) {","class":"lineCov","hits":"1","order":"3808","possible_hits":"1",},
{"lineNum":"   80","line":"    size_t ret = ROUND_TO_ALIGN(sizeof(secp256k1_context));","class":"lineCov","hits":"1","order":"3809","possible_hits":"1",},
{"lineNum":"   81","line":""},
{"lineNum":"   82","line":"    if (EXPECT((flags & SECP256K1_FLAGS_TYPE_MASK) != SECP256K1_FLAGS_TYPE_CONTEXT, 0)) {","class":"lineCov","hits":"1","order":"3810","possible_hits":"1",},
...
{"lineNum":"   86","line":"    }"},
{"lineNum":"   87","line":""},
{"lineNum":"   88","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_SIGN) {","class":"lineCov","hits":"1","order":"3811","possible_hits":"1",},
{"lineNum":"   89","line":"        ret += SECP256K1_ECMULT_GEN_CONTEXT_PREALLOCATED_SIZE;","class":"lineCov","hits":"1","order":"3812","possible_hits":"1",},
{"lineNum":"   90","line":"    }"},
{"lineNum":"   91","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_VERIFY) {","class":"lineCov","hits":"1","order":"3813","possible_hits":"1",},
{"lineNum":"   92","line":"        ret += SECP256K1_ECMULT_CONTEXT_PREALLOCATED_SIZE;","class":"lineCov","hits":"1","order":"3814","possible_hits":"1",},
{"lineNum":"   93","line":"    }"},
{"lineNum":"   94","line":"    return ret;","class":"lineCov","hits":"1","order":"3815","possible_hits":"1",},
{"lineNum":"   95","line":"}","class":"linePartCov","hits":"1","order":"3816","possible_hits":"2",},
{"lineNum":"   96","line":""},
...
{"lineNum":"  107","line":"}"},
{"lineNum":"  108","line":""},
{"lineNum":"  109","line":"secp256k1_context* secp256k1_context_preallocated_create(void* prealloc, unsigned int flags) {","class":"lineCov","hits":"1","order":"3867","possible_hits":"1",},
{"lineNum":"  110","line":"    void* const base = prealloc;","class":"lineCov","hits":"1","order":"3868","possible_hits":"1",},
{"lineNum":"  111","line":"    size_t prealloc_size;"},
{"lineNum":"  112","line":"    secp256k1_context* ret;"},
{"lineNum":"  113","line":""},
{"lineNum":"  114","line":"    VERIFY_CHECK(prealloc != NULL);"},
{"lineNum":"  115","line":"    prealloc_size = secp256k1_context_preallocated_size(flags);","class":"lineCov","hits":"1","order":"3869","possible_hits":"1",},
{"lineNum":"  116","line":"    ret = (secp256k1_context*)manual_alloc(&prealloc, sizeof(secp256k1_context), base, prealloc_size);","class":"lineCov","hits":"1","order":"3870","possible_hits":"1",},
{"lineNum":"  117","line":"    ret->illegal_callback = default_illegal_callback;","class":"lineCov","hits":"1","order":"3877","possible_hits":"1",},
{"lineNum":"  118","line":"    ret->error_callback = default_error_callback;","class":"lineCov","hits":"1","order":"3878","possible_hits":"1",},
{"lineNum":"  119","line":""},
{"lineNum":"  120","line":"    if (EXPECT((flags & SECP256K1_FLAGS_TYPE_MASK) != SECP256K1_FLAGS_TYPE_CONTEXT, 0)) {","class":"lineCov","hits":"1","order":"3879","possible_hits":"1",},
...
{"lineNum":"  124","line":"    }"},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"    secp256k1_ecmult_context_init(&ret->ecmult_ctx);","class":"lineCov","hits":"1","order":"3880","possible_hits":"1",},
{"lineNum":"  127","line":"    secp256k1_ecmult_gen_context_init(&ret->ecmult_gen_ctx);","class":"lineCov","hits":"1","order":"3884","possible_hits":"1",},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_SIGN) {","class":"lineCov","hits":"1","order":"3888","possible_hits":"1",},
{"lineNum":"  130","line":"        secp256k1_ecmult_gen_context_build(&ret->ecmult_gen_ctx, &prealloc);","class":"lineCov","hits":"1","order":"3889","possible_hits":"1",},
{"lineNum":"  131","line":"    }"},
{"lineNum":"  132","line":"    if (flags & SECP256K1_FLAGS_BIT_CONTEXT_VERIFY) {","class":"lineCov","hits":"1","order":"4771","possible_hits":"1",},
{"lineNum":"  133","line":"        secp256k1_ecmult_context_build(&ret->ecmult_ctx, &prealloc);","class":"lineCov","hits":"1","order":"4772","possible_hits":"1",},
{"lineNum":"  134","line":"    }"},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"    return (secp256k1_context*) ret;","class":"lineCov","hits":"1","order":"4820","possible_hits":"1",},
{"lineNum":"  137","line":"}","class":"linePartCov","hits":"1","order":"4821","possible_hits":"2",},
{"lineNum":"  138","line":""},
...
{"lineNum":"  151","line":"}"},
{"lineNum":"  152","line":""},
{"lineNum":"  153","line":"void secp256k1_context_preallocated_destroy(secp256k1_context* ctx) {","class":"lineCov","hits":"1","order":"5249","possible_hits":"1",},
{"lineNum":"  154","line":"    ARG_CHECK_NO_RETURN(ctx != secp256k1_context_no_precomp);","class":"lineCov","hits":"1","order":"5250","possible_hits":"1",},
{"lineNum":"  155","line":"    if (ctx != NULL) {","class":"lineCov","hits":"1","order":"5251","possible_hits":"1",},
{"lineNum":"  156","line":"        secp256k1_ecmult_context_clear(&ctx->ecmult_ctx);","class":"lineCov","hits":"1","order":"5252","possible_hits":"1",},
{"lineNum":"  157","line":"        secp256k1_ecmult_gen_context_clear(&ctx->ecmult_gen_ctx);","class":"lineCov","hits":"1","order":"5256","possible_hits":"1",},
{"lineNum":"  158","line":"    }"},
{"lineNum":"  159","line":"}","class":"linePartCov","hits":"1","order":"5262","possible_hits":"2",},
{"lineNum":"  160","line":""},
...
{"lineNum":"  177","line":"}"},
{"lineNum":"  178","line":""},
{"lineNum":"  179","line":"static int secp256k1_pubkey_load(const secp256k1_context* ctx, secp256k1_ge* ge, const secp256k1_pubkey* pubkey) {","class":"lineCov","hits":"2","order":"5370","possible_hits":"2",},
...
{"lineNum":"  185","line":"        memcpy(&s, &pubkey->data[0], sizeof(s));","class":"lineCov","hits":"1","order":"5371","possible_hits":"1",},
{"lineNum":"  186","line":"        secp256k1_ge_from_storage(ge, &s);","class":"lineCov","hits":"1","order":"5372","possible_hits":"1",},
...
{"lineNum":"  193","line":"    }"},
{"lineNum":"  194","line":"    ARG_CHECK(!secp256k1_fe_is_zero(&ge->x));","class":"lineCov","hits":"1","order":"5373","possible_hits":"1",},
{"lineNum":"  195","line":"    return 1;","class":"lineCov","hits":"1","order":"5374","possible_hits":"1",},
{"lineNum":"  196","line":"}","class":"linePartCov","hits":"1","order":"5375","possible_hits":"2",},
{"lineNum":"  197","line":""},
{"lineNum":"  198","line":"static void secp256k1_pubkey_save(secp256k1_pubkey* pubkey, secp256k1_ge* ge) {","class":"lineCov","hits":"2","order":"5234","possible_hits":"2",},
{"lineNum":"  199","line":"    if (sizeof(secp256k1_ge_storage) == 64) {"},
{"lineNum":"  200","line":"        secp256k1_ge_storage s;"},
{"lineNum":"  201","line":"        secp256k1_ge_to_storage(&s, ge);","class":"lineCov","hits":"1","order":"5235","possible_hits":"1",},
{"lineNum":"  202","line":"        memcpy(&pubkey->data[0], &s, sizeof(s));","class":"lineCov","hits":"1","order":"5236","possible_hits":"1",},
...
{"lineNum":"  209","line":"    }"},
{"lineNum":"  210","line":"}","class":"linePartCov","hits":"1","order":"5237","possible_hits":"2",},
{"lineNum":"  211","line":""},
...
{"lineNum":"  249","line":""},
{"lineNum":"  250","line":"static void secp256k1_ecdsa_signature_load(const secp256k1_context* ctx, secp256k1_scalar* r, secp256k1_scalar* s, const secp256k1_ecdsa_signature* sig) {","class":"lineCov","hits":"1","order":"5353","possible_hits":"1",},
...
{"lineNum":"  256","line":"        memcpy(r, &sig->data[0], 32);","class":"lineCov","hits":"1","order":"5354","possible_hits":"1",},
{"lineNum":"  257","line":"        memcpy(s, &sig->data[32], 32);","class":"lineCov","hits":"1","order":"5355","possible_hits":"1",},
...
{"lineNum":"  261","line":"    }"},
{"lineNum":"  262","line":"}","class":"linePartCov","hits":"1","order":"5356","possible_hits":"2",},
{"lineNum":"  263","line":""},
{"lineNum":"  264","line":"static void secp256k1_ecdsa_signature_save(secp256k1_ecdsa_signature* sig, const secp256k1_scalar* r, const secp256k1_scalar* s) {","class":"lineCov","hits":"1","order":"5324","possible_hits":"1",},
{"lineNum":"  265","line":"    if (sizeof(secp256k1_scalar) == 32) {"},
{"lineNum":"  266","line":"        memcpy(&sig->data[0], r, 32);","class":"lineCov","hits":"1","order":"5325","possible_hits":"1",},
{"lineNum":"  267","line":"        memcpy(&sig->data[32], s, 32);","class":"lineCov","hits":"1","order":"5326","possible_hits":"1",},
...
{"lineNum":"  271","line":"    }"},
{"lineNum":"  272","line":"}","class":"linePartCov","hits":"1","order":"5327","possible_hits":"2",},
{"lineNum":"  273","line":""},
...
{"lineNum":"  353","line":"}"},
{"lineNum":"  354","line":""},
{"lineNum":"  355","line":"int secp256k1_ecdsa_verify(const secp256k1_context* ctx, const secp256k1_ecdsa_signature *sig, const unsigned char *msg32, const secp256k1_pubkey *pubkey) {","class":"lineCov","hits":"2","order":"5346","possible_hits":"2",},
...
{"lineNum":"  360","line":"    ARG_CHECK(secp256k1_ecmult_context_is_built(&ctx->ecmult_ctx));","class":"lineCov","hits":"1","order":"5347","possible_hits":"1",},
{"lineNum":"  361","line":"    ARG_CHECK(msg32 != NULL);","class":"lineCov","hits":"1","order":"5348","possible_hits":"1",},
{"lineNum":"  362","line":"    ARG_CHECK(sig != NULL);","class":"lineCov","hits":"1","order":"5349","possible_hits":"1",},
{"lineNum":"  363","line":"    ARG_CHECK(pubkey != NULL);","class":"lineCov","hits":"1","order":"5350","possible_hits":"1",},
{"lineNum":"  364","line":""},
{"lineNum":"  365","line":"    secp256k1_scalar_set_b32(&m, msg32, NULL);","class":"lineCov","hits":"1","order":"5351","possible_hits":"1",},
{"lineNum":"  366","line":"    secp256k1_ecdsa_signature_load(ctx, &r, &s, sig);","class":"lineCov","hits":"1","order":"5352","possible_hits":"1",},
{"lineNum":"  367","line":"    return (!secp256k1_scalar_is_high(&s) &&","class":"lineCov","hits":"3","order":"5357","possible_hits":"3",},
{"lineNum":"  368","line":"            secp256k1_pubkey_load(ctx, &q, pubkey) &&","class":"lineCov","hits":"2","order":"5369","possible_hits":"2",},
{"lineNum":"  369","line":"            secp256k1_ecdsa_sig_verify(&ctx->ecmult_ctx, &r, &s, &q, &m));","class":"lineCov","hits":"1","order":"5376","possible_hits":"1",},
{"lineNum":"  370","line":"}","class":"lineCov","hits":"1","order":"5418","possible_hits":"1",},
{"lineNum":"  371","line":""},
...
var header = { "command" : "ser_de-d029ad6af9d5a7c5", "date" : "2019-08-31 07:54:50", "instrumented" : 89, "covered" : 59,};
var merged_data = [];
