...
{"lineNum":"   37","line":"    fn from_hex(s: &str) -> Result<Self, Error> {","class":"lineCov","hits":"1","order":"1694","possible_hits":"1",},
{"lineNum":"   38","line":"        Self::from_byte_iter(HexIterator::new(s)?)","class":"linePartCov","hits":"2","order":"1695","possible_hits":"3",},
{"lineNum":"   39","line":"    }","class":"linePartCov","hits":"2","order":"1821","possible_hits":"4",},
{"lineNum":"   40","line":"}"},
{"lineNum":"   41","line":""},
...
{"lineNum":"   51","line":"    fn from_byte_iter<I>(iter: I) -> Result<Self, Error>","class":"linePartCov","hits":"1","order":"1714","possible_hits":"2",},
...
{"lineNum":"   55","line":"    {"},
{"lineNum":"   56","line":"        let inner;","class":"lineCov","hits":"1","order":"1715","possible_hits":"1",},
{"lineNum":"   57","line":"        if Self::DISPLAY_BACKWARD {","class":"linePartCov","hits":"2","order":"1716","possible_hits":"3",},
{"lineNum":"   58","line":"            inner = T::Inner::from_byte_iter(iter.rev())?;","class":"lineNoCov","hits":"0","possible_hits":"6",},
{"lineNum":"   59","line":"        } else {"},
{"lineNum":"   60","line":"            inner = T::Inner::from_byte_iter(iter)?;","class":"linePartCov","hits":"1","order":"1717","possible_hits":"2",},
{"lineNum":"   61","line":"        }"},
{"lineNum":"   62","line":"        Ok(Hash::from_inner(inner))","class":"lineCov","hits":"1","order":"1816","possible_hits":"1",},
{"lineNum":"   63","line":"    }","class":"linePartCov","hits":"2","order":"1820","possible_hits":"4",},
{"lineNum":"   64","line":"}"},
{"lineNum":"   65","line":""},
...
{"lineNum":"   76","line":"    pub fn new(s: &\'a str) -> Result<HexIterator<\'a>, Error> {","class":"lineCov","hits":"1","order":"1696","possible_hits":"1",},
{"lineNum":"   77","line":"        if s.len() % 2 != 0 {","class":"linePartCov","hits":"1","order":"1697","possible_hits":"2",},
{"lineNum":"   78","line":"            Err(Error::OddLengthString(s.len()))","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   79","line":"        } else {"},
{"lineNum":"   80","line":"            Ok(HexIterator { iter: s.bytes() })","class":"lineCov","hits":"1","order":"1701","possible_hits":"1",},
{"lineNum":"   81","line":"        }"},
{"lineNum":"   82","line":"    }","class":"linePartCov","hits":"1","order":"1711","possible_hits":"2",},
{"lineNum":"   83","line":"}"},
{"lineNum":"   84","line":""},
{"lineNum":"   85","line":"fn chars_to_hex(hi: u8, lo: u8) -> Result<u8, Error> {","class":"lineCov","hits":"1","order":"1786","possible_hits":"1",},
{"lineNum":"   86","line":"    let hih = (hi as char)","class":"lineCov","hits":"3","order":"1787","possible_hits":"3",},
{"lineNum":"   87","line":"        .to_digit(16)"},
{"lineNum":"   88","line":"        .ok_or(Error::InvalidChar(hi))?;","class":"linePartCov","hits":"2","order":"1795","possible_hits":"4",},
{"lineNum":"   89","line":"    let loh = (lo as char)","class":"lineCov","hits":"3","order":"1796","possible_hits":"3",},
{"lineNum":"   90","line":"        .to_digit(16)"},
{"lineNum":"   91","line":"        .ok_or(Error::InvalidChar(lo))?;","class":"lineCov","hits":"2","order":"1797","possible_hits":"2",},
{"lineNum":"   92","line":""},
{"lineNum":"   93","line":"    let ret = (hih << 4) + loh;","class":"linePartCov","hits":"1","order":"1798","possible_hits":"3",},
{"lineNum":"   94","line":"    Ok(ret as u8)","class":"lineCov","hits":"1","order":"1799","possible_hits":"1",},
{"lineNum":"   95","line":"}","class":"linePartCov","hits":"2","order":"1800","possible_hits":"3",},
{"lineNum":"   96","line":""},
{"lineNum":"   97","line":"impl<\'a> Iterator for HexIterator<\'a> {"},
{"lineNum":"   98","line":"    type Item = Result<u8, Error>;"},
{"lineNum":"   99","line":""},
{"lineNum":"  100","line":"    fn next(&mut self) -> Option<Result<u8, Error>> {","class":"lineCov","hits":"1","order":"1757","possible_hits":"1",},
{"lineNum":"  101","line":"        let hi = self.iter.next()?;","class":"lineCov","hits":"3","order":"1758","possible_hits":"3",},
{"lineNum":"  102","line":"        let lo = self.iter.next().unwrap();","class":"lineCov","hits":"1","order":"1782","possible_hits":"1",},
{"lineNum":"  103","line":"        Some(chars_to_hex(hi, lo))","class":"lineCov","hits":"1","order":"1785","possible_hits":"1",},
{"lineNum":"  104","line":"    }","class":"linePartCov","hits":"2","order":"1801","possible_hits":"4",},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"    fn size_hint(&self) -> (usize, Option<usize>) {","class":"lineCov","hits":"1","order":"1722","possible_hits":"1",},
{"lineNum":"  107","line":"        let (min, max) = self.iter.size_hint();","class":"lineCov","hits":"1","order":"1723","possible_hits":"1",},
{"lineNum":"  108","line":"        (min / 2, max.map(|x| x /2))","class":"lineCov","hits":"3","order":"1733","possible_hits":"3",},
{"lineNum":"  109","line":"    }","class":"linePartCov","hits":"1","order":"1736","possible_hits":"2",},
{"lineNum":"  110","line":"}"},
{"lineNum":"  111","line":""},
...
{"lineNum":"  182","line":"            fn from_byte_iter<I>(iter: I) -> Result<Self, Error>","class":"linePartCov","hits":"1","order":"1718","possible_hits":"4",},
...
{"lineNum":"  186","line":"            {"},
{"lineNum":"  187","line":"                if iter.len() == $len {","class":"linePartCov","hits":"3","order":"1719","possible_hits":"6",},
{"lineNum":"  188","line":"                    let mut ret = [0; $len];","class":"linePartCov","hits":"1","order":"1744","possible_hits":"2",},
{"lineNum":"  189","line":"                    for (n, byte) in iter.enumerate() {","class":"linePartCov","hits":"4","order":"1745","possible_hits":"10",},
{"lineNum":"  190","line":"                        ret[n] = byte?;","class":"linePartCov","hits":"3","order":"1807","possible_hits":"8",},
{"lineNum":"  191","line":"                    }"},
{"lineNum":"  192","line":"                    Ok(ret)","class":"linePartCov","hits":"1","order":"1814","possible_hits":"2",},
{"lineNum":"  193","line":"                } else {"},
{"lineNum":"  194","line":"                    Err(Error::InvalidLength(2 * $len, 2 * iter.len()))","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"  195","line":"                }"},
{"lineNum":"  196","line":"            }","class":"linePartCov","hits":"2","order":"1815","possible_hits":"6",},
{"lineNum":"  197","line":"        }"},
{"lineNum":"  198","line":"    }"},
{"lineNum":"  199","line":"}"},
{"lineNum":"  200","line":""},
...
var header = { "command" : "ser_de-d029ad6af9d5a7c5", "date" : "2019-08-31 07:54:50", "instrumented" : 67, "covered" : 37,};
var merged_data = [];
