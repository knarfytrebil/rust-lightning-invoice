...
{"lineNum":"   16","line":""},
{"lineNum":"   17","line":"static int secp256k1_eckey_pubkey_parse(secp256k1_ge *elem, const unsigned char *pub, size_t size) {","class":"lineCov","hits":"2","order":"2354","possible_hits":"2",},
{"lineNum":"   18","line":"    if (size == 33 && (pub[0] == SECP256K1_TAG_PUBKEY_EVEN || pub[0] == SECP256K1_TAG_PUBKEY_ODD)) {","class":"lineCov","hits":"1","order":"2355","possible_hits":"1",},
{"lineNum":"   19","line":"        secp256k1_fe x;"},
{"lineNum":"   20","line":"        return secp256k1_fe_set_b32(&x, pub+1) && secp256k1_ge_set_xo_var(elem, &x, pub[0] == SECP256K1_TAG_PUBKEY_ODD);","class":"lineCov","hits":"1","order":"2356","possible_hits":"1",},
...
{"lineNum":"   34","line":"    }"},
{"lineNum":"   35","line":"}","class":"lineCov","hits":"1","order":"2611","possible_hits":"1",},
{"lineNum":"   36","line":""},
{"lineNum":"   37","line":"static int secp256k1_eckey_pubkey_serialize(secp256k1_ge *elem, unsigned char *pub, size_t *size, int compressed) {","class":"lineCov","hits":"1","order":"5186","possible_hits":"1",},
{"lineNum":"   38","line":"    if (secp256k1_ge_is_infinity(elem)) {","class":"lineCov","hits":"1","order":"5187","possible_hits":"1",},
{"lineNum":"   39","line":"        return 0;","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   40","line":"    }"},
{"lineNum":"   41","line":"    secp256k1_fe_normalize_var(&elem->x);","class":"lineCov","hits":"1","order":"5191","possible_hits":"1",},
{"lineNum":"   42","line":"    secp256k1_fe_normalize_var(&elem->y);","class":"lineCov","hits":"1","order":"5192","possible_hits":"1",},
{"lineNum":"   43","line":"    secp256k1_fe_get_b32(&pub[1], &elem->x);","class":"lineCov","hits":"1","order":"5193","possible_hits":"1",},
{"lineNum":"   44","line":"    if (compressed) {","class":"lineCov","hits":"1","order":"5228","possible_hits":"1",},
{"lineNum":"   45","line":"        *size = 33;","class":"lineCov","hits":"1","order":"5229","possible_hits":"1",},
{"lineNum":"   46","line":"        pub[0] = secp256k1_fe_is_odd(&elem->y) ? SECP256K1_TAG_PUBKEY_ODD : SECP256K1_TAG_PUBKEY_EVEN;","class":"lineCov","hits":"1","order":"5230","possible_hits":"1",},
...
{"lineNum":"   51","line":"    }"},
{"lineNum":"   52","line":"    return 1;","class":"lineCov","hits":"1","order":"5231","possible_hits":"1",},
{"lineNum":"   53","line":"}","class":"linePartCov","hits":"1","order":"5232","possible_hits":"2",},
{"lineNum":"   54","line":""},
...
var header = { "command" : "lightning_invoice-99c93907235ac8b4", "date" : "2019-08-31 07:54:49", "instrumented" : 27, "covered" : 14,};
var merged_data = [];
