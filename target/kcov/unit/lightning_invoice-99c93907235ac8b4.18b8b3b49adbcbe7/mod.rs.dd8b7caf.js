...
{"lineNum":"   34","line":"#[derive(Copy, Clone, PartialEq, Eq, Debug)]","class":"linePartCov","hits":"2","order":"4000","possible_hits":"6",},
{"lineNum":"   35","line":"pub struct RecoverableSignature(ffi::RecoverableSignature);","class":"linePartCov","hits":"1","order":"4001","possible_hits":"3",},
{"lineNum":"   36","line":""},
...
{"lineNum":"   40","line":"pub fn from_i32(id: i32) -> Result<RecoveryId, Error> {","class":"lineCov","hits":"1","order":"3723","possible_hits":"1",},
{"lineNum":"   41","line":"    match id {","class":"lineCov","hits":"1","order":"3725","possible_hits":"1",},
{"lineNum":"   42","line":"        0 | 1 | 2 | 3 => Ok(RecoveryId(id)),","class":"lineCov","hits":"1","order":"3724","possible_hits":"1",},
{"lineNum":"   43","line":"        _ => Err(Error::InvalidRecoveryId)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   44","line":"    }"},
{"lineNum":"   45","line":"}","class":"linePartCov","hits":"1","order":"3726","possible_hits":"2",},
{"lineNum":"   46","line":""},
{"lineNum":"   47","line":"#[inline]"},
{"lineNum":"   48","line":"/// Allows library users to convert recovery IDs to i32."},
{"lineNum":"   49","line":"pub fn to_i32(self) -> i32 {"},
{"lineNum":"   50","line":"    self.0"},
{"lineNum":"   51","line":"}"},
{"lineNum":"   52","line":"}"},
{"lineNum":"   53","line":""},
...
{"lineNum":"   59","line":"    pub fn from_compact(data: &[u8], recid: RecoveryId) -> Result<RecoverableSignature, Error> {","class":"lineCov","hits":"1","order":"3730","possible_hits":"1",},
{"lineNum":"   60","line":"        let mut ret = unsafe { ffi::RecoverableSignature::blank() };","class":"lineCov","hits":"1","order":"3731","possible_hits":"1",},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"        unsafe {"},
{"lineNum":"   63","line":"            if data.len() != 64 {","class":"linePartCov","hits":"2","order":"3733","possible_hits":"3",},
{"lineNum":"   64","line":"                Err(Error::InvalidSignature)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   65","line":"            } else if ffi::secp256k1_ecdsa_recoverable_signature_parse_compact(","class":"lineCov","hits":"2","order":"3737","possible_hits":"2",},
{"lineNum":"   66","line":"                super_ffi::secp256k1_context_no_precomp,","class":"lineCov","hits":"1","order":"3734","possible_hits":"1",},
{"lineNum":"   67","line":"                &mut ret,"},
{"lineNum":"   68","line":"                data.as_ptr(),","class":"lineCov","hits":"1","order":"3735","possible_hits":"1",},
{"lineNum":"   69","line":"                recid.0,","class":"lineCov","hits":"1","order":"3736","possible_hits":"1",},
{"lineNum":"   70","line":"            ) == 1"},
{"lineNum":"   71","line":"            {"},
{"lineNum":"   72","line":"                Ok(RecoverableSignature(ret))","class":"lineCov","hits":"1","order":"3798","possible_hits":"1",},
{"lineNum":"   73","line":"            } else {"},
{"lineNum":"   74","line":"                Err(Error::InvalidSignature)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   75","line":"            }"},
{"lineNum":"   76","line":"        }"},
{"lineNum":"   77","line":"    }","class":"linePartCov","hits":"1","order":"3801","possible_hits":"2",},
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"    /// Obtains a raw pointer suitable for use with FFI functions"},
{"lineNum":"   80","line":"    #[inline]"},
{"lineNum":"   81","line":"    pub fn as_ptr(&self) -> *const ffi::RecoverableSignature {","class":"lineCov","hits":"1","order":"5667","possible_hits":"1",},
{"lineNum":"   82","line":"        &self.0 as *const _","class":"lineCov","hits":"1","order":"5668","possible_hits":"1",},
{"lineNum":"   83","line":"    }","class":"linePartCov","hits":"1","order":"5669","possible_hits":"2",},
{"lineNum":"   84","line":""},
{"lineNum":"   85","line":"    #[inline]"},
{"lineNum":"   86","line":"    /// Serializes the recoverable signature in compact format"},
{"lineNum":"   87","line":"    pub fn serialize_compact(&self) -> (RecoveryId, [u8; 64]) {"},
{"lineNum":"   88","line":"        let mut ret = [0u8; 64];"},
{"lineNum":"   89","line":"        let mut recid = 0i32;"},
{"lineNum":"   90","line":"        unsafe {"},
{"lineNum":"   91","line":"            let err = ffi::secp256k1_ecdsa_recoverable_signature_serialize_compact("},
{"lineNum":"   92","line":"                super_ffi::secp256k1_context_no_precomp,"},
{"lineNum":"   93","line":"                ret.as_mut_ptr(),"},
{"lineNum":"   94","line":"                &mut recid,"},
{"lineNum":"   95","line":"                self.as_ptr(),"},
{"lineNum":"   96","line":"            );"},
{"lineNum":"   97","line":"            assert!(err == 1);"},
{"lineNum":"   98","line":"        }"},
{"lineNum":"   99","line":"        (RecoveryId(recid), ret)"},
{"lineNum":"  100","line":"    }"},
{"lineNum":"  101","line":""},
...
{"lineNum":"  105","line":"    pub fn to_standard(&self) -> Signature {","class":"lineCov","hits":"1","order":"5905","possible_hits":"1",},
{"lineNum":"  106","line":"        let mut ret = unsafe { super_ffi::Signature::blank() };","class":"lineCov","hits":"1","order":"5906","possible_hits":"1",},
{"lineNum":"  107","line":"        unsafe {"},
{"lineNum":"  108","line":"            let err = ffi::secp256k1_ecdsa_recoverable_signature_convert(","class":"lineCov","hits":"1","order":"5910","possible_hits":"1",},
{"lineNum":"  109","line":"                super_ffi::secp256k1_context_no_precomp,","class":"lineCov","hits":"1","order":"5908","possible_hits":"1",},
{"lineNum":"  110","line":"                &mut ret,"},
{"lineNum":"  111","line":"                self.as_ptr(),","class":"lineCov","hits":"1","order":"5909","possible_hits":"1",},
{"lineNum":"  112","line":"            );"},
{"lineNum":"  113","line":"            assert!(err == 1);","class":"lineCov","hits":"1","order":"5922","possible_hits":"1",},
{"lineNum":"  114","line":"        }"},
{"lineNum":"  115","line":"        Signature(ret)","class":"lineCov","hits":"1","order":"5923","possible_hits":"1",},
{"lineNum":"  116","line":"    }","class":"linePartCov","hits":"1","order":"5924","possible_hits":"2",},
{"lineNum":"  117","line":"}"},
{"lineNum":"  118","line":""},
...
{"lineNum":"  122","line":"    fn from(sig: ffi::RecoverableSignature) -> RecoverableSignature {","class":"lineCov","hits":"1","order":"5598","possible_hits":"1",},
{"lineNum":"  123","line":"        RecoverableSignature(sig)","class":"lineCov","hits":"1","order":"5599","possible_hits":"1",},
{"lineNum":"  124","line":"    }","class":"linePartCov","hits":"1","order":"5600","possible_hits":"2",},
{"lineNum":"  125","line":"}"},
{"lineNum":"  126","line":""},
...
{"lineNum":"  130","line":"    pub fn sign_recoverable(&self, msg: &Message, sk: &key::SecretKey)","class":"lineCov","hits":"1","order":"5292","possible_hits":"1",},
{"lineNum":"  131","line":"                            -> RecoverableSignature {"},
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"        let mut ret = unsafe { ffi::RecoverableSignature::blank() };","class":"lineCov","hits":"1","order":"5293","possible_hits":"1",},
...
{"lineNum":"  138","line":"                ffi::secp256k1_ecdsa_sign_recoverable(","class":"lineCov","hits":"1","order":"5299","possible_hits":"1",},
{"lineNum":"  139","line":"                    self.ctx,","class":"lineCov","hits":"1","order":"5294","possible_hits":"1",},
{"lineNum":"  140","line":"                    &mut ret,"},
{"lineNum":"  141","line":"                    msg.as_ptr(),","class":"lineCov","hits":"1","order":"5295","possible_hits":"1",},
{"lineNum":"  142","line":"                    sk.as_ptr(),","class":"lineCov","hits":"1","order":"5296","possible_hits":"1",},
{"lineNum":"  143","line":"                    super_ffi::secp256k1_nonce_function_rfc6979,","class":"lineCov","hits":"1","order":"5297","possible_hits":"1",},
{"lineNum":"  144","line":"                    ptr::null()","class":"lineCov","hits":"1","order":"5298","possible_hits":"1",},
{"lineNum":"  145","line":"                ),"},
{"lineNum":"  146","line":"                1"},
{"lineNum":"  147","line":"            );"},
{"lineNum":"  148","line":"        }"},
{"lineNum":"  149","line":""},
{"lineNum":"  150","line":"        RecoverableSignature::from(ret)","class":"lineCov","hits":"1","order":"5597","possible_hits":"1",},
{"lineNum":"  151","line":"    }","class":"linePartCov","hits":"1","order":"5601","possible_hits":"2",},
{"lineNum":"  152","line":"}"},
{"lineNum":"  153","line":""},
...
{"lineNum":"  157","line":"    pub fn recover(&self, msg: &Message, sig: &RecoverableSignature)","class":"lineCov","hits":"1","order":"5663","possible_hits":"1",},
{"lineNum":"  158","line":"                   -> Result<key::PublicKey, Error> {"},
{"lineNum":"  159","line":""},
{"lineNum":"  160","line":"        let mut pk = unsafe { super_ffi::PublicKey::blank() };","class":"lineCov","hits":"1","order":"5664","possible_hits":"1",},
{"lineNum":"  161","line":""},
{"lineNum":"  162","line":"        unsafe {"},
{"lineNum":"  163","line":"            if ffi::secp256k1_ecdsa_recover(self.ctx, &mut pk,","class":"lineCov","hits":"2","order":"5665","possible_hits":"2",},
{"lineNum":"  164","line":"                                            sig.as_ptr(), msg.as_ptr()) != 1 {","class":"lineCov","hits":"1","order":"5666","possible_hits":"1",},
{"lineNum":"  165","line":"                return Err(Error::InvalidSignature);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  166","line":"            }"},
{"lineNum":"  167","line":"        };"},
{"lineNum":"  168","line":"        Ok(key::PublicKey::from(pk))","class":"lineCov","hits":"1","order":"5856","possible_hits":"1",},
{"lineNum":"  169","line":"    }","class":"linePartCov","hits":"2","order":"5860","possible_hits":"3",},
{"lineNum":"  170","line":"}"},
{"lineNum":"  171","line":""},
{"lineNum":"  172","line":""},
...
var header = { "command" : "lightning_invoice-99c93907235ac8b4", "date" : "2019-08-31 07:54:49", "instrumented" : 49, "covered" : 45,};
var merged_data = [];
