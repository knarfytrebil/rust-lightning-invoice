...
{"lineNum":"   48","line":"    fn midstate(&self) -> Midstate {","class":"lineCov","hits":"1","order":"3647","possible_hits":"1",},
{"lineNum":"   49","line":"        let mut ret = [0; 32];","class":"lineCov","hits":"1","order":"3648","possible_hits":"1",},
{"lineNum":"   50","line":"        BigEndian::write_u32_into(&self.h, &mut ret);","class":"lineCov","hits":"1","order":"3649","possible_hits":"1",},
{"lineNum":"   51","line":"        Midstate(ret)","class":"lineCov","hits":"1","order":"3705","possible_hits":"1",},
{"lineNum":"   52","line":"    }","class":"linePartCov","hits":"1","order":"3706","possible_hits":"2",},
{"lineNum":"   53","line":""},
...
{"lineNum":"   67","line":"#[derive(Copy, Clone, PartialEq, Eq, Default, PartialOrd, Ord, Hash)]","class":"linePartCov","hits":"4","order":"2871","possible_hits":"5",},
{"lineNum":"   68","line":"pub struct Hash([u8; 32]);","class":"lineCov","hits":"1","order":"2872","possible_hits":"1",},
{"lineNum":"   69","line":""},
...
{"lineNum":"   87","line":""},
{"lineNum":"   88","line":"    fn engine() -> HashEngine {","class":"lineCov","hits":"1","order":"3460","possible_hits":"1",},
{"lineNum":"   89","line":"        HashEngine {","class":"lineCov","hits":"1","order":"3466","possible_hits":"1",},
{"lineNum":"   90","line":"            h: [0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19],","class":"lineCov","hits":"1","order":"3462","possible_hits":"1",},
{"lineNum":"   91","line":"            length: 0,"},
{"lineNum":"   92","line":"            buffer: [0; BLOCK_SIZE],","class":"lineCov","hits":"1","order":"3464","possible_hits":"1",},
{"lineNum":"   93","line":"        }"},
{"lineNum":"   94","line":"    }","class":"linePartCov","hits":"1","order":"3467","possible_hits":"2",},
{"lineNum":"   95","line":""},
{"lineNum":"   96","line":"    #[cfg(not(feature = \"fuzztarget\"))]"},
{"lineNum":"   97","line":"    fn from_engine(mut e: HashEngine) -> Hash {","class":"lineCov","hits":"1","order":"3628","possible_hits":"1",},
{"lineNum":"   98","line":"        // pad buffer with a single 1-bit then all 0s, until there are exactly 8 bytes remaining"},
{"lineNum":"   99","line":"        let data_len = e.length as u64;","class":"lineCov","hits":"1","order":"3629","possible_hits":"1",},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"        let zeroes = [0; BLOCK_SIZE - 8];","class":"lineCov","hits":"1","order":"3630","possible_hits":"1",},
{"lineNum":"  102","line":"        e.input(&[0x80]);","class":"lineCov","hits":"1","order":"3631","possible_hits":"1",},
{"lineNum":"  103","line":"        if e.length % BLOCK_SIZE > zeroes.len() {","class":"linePartCov","hits":"1","order":"3632","possible_hits":"2",},
{"lineNum":"  104","line":"            e.input(&zeroes);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  105","line":"        }"},
{"lineNum":"  106","line":"        let pad_length = zeroes.len() - (e.length % BLOCK_SIZE);","class":"linePartCov","hits":"1","order":"3633","possible_hits":"2",},
{"lineNum":"  107","line":"        e.input(&zeroes[..pad_length]);","class":"lineCov","hits":"1","order":"3634","possible_hits":"1",},
{"lineNum":"  108","line":"        debug_assert_eq!(e.length % BLOCK_SIZE, zeroes.len());","class":"lineCov","hits":"1","order":"3635","possible_hits":"1",},
{"lineNum":"  109","line":""},
{"lineNum":"  110","line":"        let mut len_buf = [0; 8];","class":"lineCov","hits":"1","order":"3636","possible_hits":"1",},
{"lineNum":"  111","line":"        BigEndian::write_u64(&mut len_buf, 8 * data_len);","class":"linePartCov","hits":"1","order":"3637","possible_hits":"3",},
{"lineNum":"  112","line":"        e.input(&len_buf);","class":"lineCov","hits":"1","order":"3644","possible_hits":"1",},
{"lineNum":"  113","line":"        debug_assert_eq!(e.length % BLOCK_SIZE, 0);","class":"lineCov","hits":"1","order":"3645","possible_hits":"1",},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"        Hash(e.midstate().into_inner())","class":"lineCov","hits":"1","order":"3646","possible_hits":"1",},
{"lineNum":"  116","line":"    }","class":"lineCov","hits":"1","order":"3710","possible_hits":"1",},
{"lineNum":"  117","line":""},
...
{"lineNum":"  124","line":""},
{"lineNum":"  125","line":"    fn from_slice(sl: &[u8]) -> Result<Hash, Error> {","class":"lineCov","hits":"1","order":"2861","possible_hits":"1",},
{"lineNum":"  126","line":"        if sl.len() != 32 {","class":"linePartCov","hits":"1","order":"2862","possible_hits":"2",},
{"lineNum":"  127","line":"            Err(Error::InvalidLength(Self::LEN, sl.len()))","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  128","line":"        } else {"},
{"lineNum":"  129","line":"            let mut ret = [0; 32];","class":"lineCov","hits":"1","order":"2863","possible_hits":"1",},
{"lineNum":"  130","line":"            ret.copy_from_slice(sl);","class":"lineCov","hits":"1","order":"2864","possible_hits":"1",},
{"lineNum":"  131","line":"            Ok(Hash(ret))","class":"lineCov","hits":"1","order":"2865","possible_hits":"1",},
{"lineNum":"  132","line":"        }"},
{"lineNum":"  133","line":"    }","class":"linePartCov","hits":"1","order":"2866","possible_hits":"2",},
{"lineNum":"  134","line":""},
{"lineNum":"  135","line":"    fn into_inner(self) -> Self::Inner {"},
{"lineNum":"  136","line":"        self.0"},
{"lineNum":"  137","line":"    }"},
{"lineNum":"  138","line":""},
{"lineNum":"  139","line":"    fn from_inner(inner: Self::Inner) -> Self {","class":"lineCov","hits":"1","order":"2851","possible_hits":"1",},
{"lineNum":"  140","line":"        Hash(inner)","class":"lineCov","hits":"1","order":"2852","possible_hits":"1",},
{"lineNum":"  141","line":"    }","class":"linePartCov","hits":"1","order":"2853","possible_hits":"2",},
{"lineNum":"  142","line":"}"},
{"lineNum":"  143","line":""},
...
{"lineNum":"  181","line":"    pub fn into_inner(self) -> [u8; 32] {","class":"lineCov","hits":"1","order":"3707","possible_hits":"1",},
{"lineNum":"  182","line":"        self.0","class":"lineCov","hits":"1","order":"3708","possible_hits":"1",},
{"lineNum":"  183","line":"    }","class":"linePartCov","hits":"1","order":"3709","possible_hits":"2",},
{"lineNum":"  184","line":"}"},
{"lineNum":"  185","line":""},
...
{"lineNum":"  237","line":"    fn process_block(&mut self) {","class":"lineCov","hits":"1","order":"3496","possible_hits":"1",},
{"lineNum":"  238","line":"        debug_assert_eq!(self.buffer.len(), BLOCK_SIZE);","class":"lineCov","hits":"1","order":"3497","possible_hits":"1",},
{"lineNum":"  239","line":""},
{"lineNum":"  240","line":"        let mut w = [0u32; 16];","class":"lineCov","hits":"1","order":"3499","possible_hits":"1",},
{"lineNum":"  241","line":"        BigEndian::read_u32_into(&self.buffer, &mut w);","class":"lineCov","hits":"1","order":"3501","possible_hits":"1",},
{"lineNum":"  242","line":""},
{"lineNum":"  243","line":"        let mut a = self.h[0];","class":"lineCov","hits":"1","order":"3544","possible_hits":"1",},
{"lineNum":"  244","line":"        let mut b = self.h[1];","class":"lineCov","hits":"1","order":"3545","possible_hits":"1",},
{"lineNum":"  245","line":"        let mut c = self.h[2];","class":"lineCov","hits":"1","order":"3546","possible_hits":"1",},
{"lineNum":"  246","line":"        let mut d = self.h[3];","class":"lineCov","hits":"1","order":"3547","possible_hits":"1",},
{"lineNum":"  247","line":"        let mut e = self.h[4];","class":"lineCov","hits":"1","order":"3548","possible_hits":"1",},
{"lineNum":"  248","line":"        let mut f = self.h[5];","class":"lineCov","hits":"1","order":"3549","possible_hits":"1",},
{"lineNum":"  249","line":"        let mut g = self.h[6];","class":"lineCov","hits":"1","order":"3550","possible_hits":"1",},
{"lineNum":"  250","line":"        let mut h = self.h[7];","class":"lineCov","hits":"1","order":"3551","possible_hits":"1",},
{"lineNum":"  251","line":""},
{"lineNum":"  252","line":"        round!(a, b, c, d, e, f, g, h, 0x428a2f98, w[0]);","class":"linePartCov","hits":"1","order":"3552","possible_hits":"2",},
{"lineNum":"  253","line":"        round!(h, a, b, c, d, e, f, g, 0x71374491, w[1]);","class":"linePartCov","hits":"1","order":"3553","possible_hits":"2",},
{"lineNum":"  254","line":"        round!(g, h, a, b, c, d, e, f, 0xb5c0fbcf, w[2]);","class":"linePartCov","hits":"1","order":"3554","possible_hits":"2",},
{"lineNum":"  255","line":"        round!(f, g, h, a, b, c, d, e, 0xe9b5dba5, w[3]);","class":"linePartCov","hits":"1","order":"3555","possible_hits":"2",},
{"lineNum":"  256","line":"        round!(e, f, g, h, a, b, c, d, 0x3956c25b, w[4]);","class":"linePartCov","hits":"1","order":"3556","possible_hits":"2",},
{"lineNum":"  257","line":"        round!(d, e, f, g, h, a, b, c, 0x59f111f1, w[5]);","class":"linePartCov","hits":"1","order":"3557","possible_hits":"2",},
{"lineNum":"  258","line":"        round!(c, d, e, f, g, h, a, b, 0x923f82a4, w[6]);","class":"linePartCov","hits":"1","order":"3558","possible_hits":"2",},
{"lineNum":"  259","line":"        round!(b, c, d, e, f, g, h, a, 0xab1c5ed5, w[7]);","class":"linePartCov","hits":"1","order":"3559","possible_hits":"2",},
{"lineNum":"  260","line":"        round!(a, b, c, d, e, f, g, h, 0xd807aa98, w[8]);","class":"linePartCov","hits":"1","order":"3560","possible_hits":"2",},
{"lineNum":"  261","line":"        round!(h, a, b, c, d, e, f, g, 0x12835b01, w[9]);","class":"linePartCov","hits":"1","order":"3561","possible_hits":"2",},
{"lineNum":"  262","line":"        round!(g, h, a, b, c, d, e, f, 0x243185be, w[10]);","class":"linePartCov","hits":"1","order":"3562","possible_hits":"2",},
{"lineNum":"  263","line":"        round!(f, g, h, a, b, c, d, e, 0x550c7dc3, w[11]);","class":"linePartCov","hits":"1","order":"3563","possible_hits":"2",},
{"lineNum":"  264","line":"        round!(e, f, g, h, a, b, c, d, 0x72be5d74, w[12]);","class":"linePartCov","hits":"1","order":"3564","possible_hits":"2",},
{"lineNum":"  265","line":"        round!(d, e, f, g, h, a, b, c, 0x80deb1fe, w[13]);","class":"linePartCov","hits":"1","order":"3565","possible_hits":"2",},
{"lineNum":"  266","line":"        round!(c, d, e, f, g, h, a, b, 0x9bdc06a7, w[14]);","class":"linePartCov","hits":"1","order":"3566","possible_hits":"2",},
{"lineNum":"  267","line":"        round!(b, c, d, e, f, g, h, a, 0xc19bf174, w[15]);","class":"linePartCov","hits":"1","order":"3567","possible_hits":"2",},
{"lineNum":"  268","line":""},
{"lineNum":"  269","line":"        round!(a, b, c, d, e, f, g, h, 0xe49b69c1, w[0], w[14], w[9], w[1]);","class":"linePartCov","hits":"1","order":"3568","possible_hits":"2",},
{"lineNum":"  270","line":"        round!(h, a, b, c, d, e, f, g, 0xefbe4786, w[1], w[15], w[10], w[2]);","class":"linePartCov","hits":"1","order":"3569","possible_hits":"2",},
{"lineNum":"  271","line":"        round!(g, h, a, b, c, d, e, f, 0x0fc19dc6, w[2], w[0], w[11], w[3]);","class":"linePartCov","hits":"1","order":"3570","possible_hits":"2",},
{"lineNum":"  272","line":"        round!(f, g, h, a, b, c, d, e, 0x240ca1cc, w[3], w[1], w[12], w[4]);","class":"linePartCov","hits":"1","order":"3571","possible_hits":"2",},
{"lineNum":"  273","line":"        round!(e, f, g, h, a, b, c, d, 0x2de92c6f, w[4], w[2], w[13], w[5]);","class":"linePartCov","hits":"1","order":"3572","possible_hits":"2",},
{"lineNum":"  274","line":"        round!(d, e, f, g, h, a, b, c, 0x4a7484aa, w[5], w[3], w[14], w[6]);","class":"linePartCov","hits":"1","order":"3573","possible_hits":"2",},
{"lineNum":"  275","line":"        round!(c, d, e, f, g, h, a, b, 0x5cb0a9dc, w[6], w[4], w[15], w[7]);","class":"linePartCov","hits":"1","order":"3574","possible_hits":"2",},
{"lineNum":"  276","line":"        round!(b, c, d, e, f, g, h, a, 0x76f988da, w[7], w[5], w[0], w[8]);","class":"linePartCov","hits":"1","order":"3575","possible_hits":"2",},
{"lineNum":"  277","line":"        round!(a, b, c, d, e, f, g, h, 0x983e5152, w[8], w[6], w[1], w[9]);","class":"linePartCov","hits":"1","order":"3576","possible_hits":"2",},
{"lineNum":"  278","line":"        round!(h, a, b, c, d, e, f, g, 0xa831c66d, w[9], w[7], w[2], w[10]);","class":"linePartCov","hits":"1","order":"3577","possible_hits":"2",},
{"lineNum":"  279","line":"        round!(g, h, a, b, c, d, e, f, 0xb00327c8, w[10], w[8], w[3], w[11]);","class":"linePartCov","hits":"1","order":"3578","possible_hits":"2",},
{"lineNum":"  280","line":"        round!(f, g, h, a, b, c, d, e, 0xbf597fc7, w[11], w[9], w[4], w[12]);","class":"linePartCov","hits":"1","order":"3579","possible_hits":"2",},
{"lineNum":"  281","line":"        round!(e, f, g, h, a, b, c, d, 0xc6e00bf3, w[12], w[10], w[5], w[13]);","class":"linePartCov","hits":"1","order":"3580","possible_hits":"2",},
{"lineNum":"  282","line":"        round!(d, e, f, g, h, a, b, c, 0xd5a79147, w[13], w[11], w[6], w[14]);","class":"linePartCov","hits":"1","order":"3581","possible_hits":"2",},
{"lineNum":"  283","line":"        round!(c, d, e, f, g, h, a, b, 0x06ca6351, w[14], w[12], w[7], w[15]);","class":"linePartCov","hits":"1","order":"3582","possible_hits":"2",},
{"lineNum":"  284","line":"        round!(b, c, d, e, f, g, h, a, 0x14292967, w[15], w[13], w[8], w[0]);","class":"linePartCov","hits":"1","order":"3583","possible_hits":"2",},
{"lineNum":"  285","line":""},
{"lineNum":"  286","line":"        round!(a, b, c, d, e, f, g, h, 0x27b70a85, w[0], w[14], w[9], w[1]);","class":"linePartCov","hits":"1","order":"3584","possible_hits":"2",},
{"lineNum":"  287","line":"        round!(h, a, b, c, d, e, f, g, 0x2e1b2138, w[1], w[15], w[10], w[2]);","class":"linePartCov","hits":"1","order":"3585","possible_hits":"2",},
{"lineNum":"  288","line":"        round!(g, h, a, b, c, d, e, f, 0x4d2c6dfc, w[2], w[0], w[11], w[3]);","class":"linePartCov","hits":"1","order":"3586","possible_hits":"2",},
{"lineNum":"  289","line":"        round!(f, g, h, a, b, c, d, e, 0x53380d13, w[3], w[1], w[12], w[4]);","class":"linePartCov","hits":"1","order":"3587","possible_hits":"2",},
{"lineNum":"  290","line":"        round!(e, f, g, h, a, b, c, d, 0x650a7354, w[4], w[2], w[13], w[5]);","class":"linePartCov","hits":"1","order":"3588","possible_hits":"2",},
{"lineNum":"  291","line":"        round!(d, e, f, g, h, a, b, c, 0x766a0abb, w[5], w[3], w[14], w[6]);","class":"linePartCov","hits":"1","order":"3589","possible_hits":"2",},
{"lineNum":"  292","line":"        round!(c, d, e, f, g, h, a, b, 0x81c2c92e, w[6], w[4], w[15], w[7]);","class":"linePartCov","hits":"1","order":"3590","possible_hits":"2",},
{"lineNum":"  293","line":"        round!(b, c, d, e, f, g, h, a, 0x92722c85, w[7], w[5], w[0], w[8]);","class":"linePartCov","hits":"1","order":"3591","possible_hits":"2",},
{"lineNum":"  294","line":"        round!(a, b, c, d, e, f, g, h, 0xa2bfe8a1, w[8], w[6], w[1], w[9]);","class":"linePartCov","hits":"1","order":"3592","possible_hits":"2",},
{"lineNum":"  295","line":"        round!(h, a, b, c, d, e, f, g, 0xa81a664b, w[9], w[7], w[2], w[10]);","class":"linePartCov","hits":"1","order":"3593","possible_hits":"2",},
{"lineNum":"  296","line":"        round!(g, h, a, b, c, d, e, f, 0xc24b8b70, w[10], w[8], w[3], w[11]);","class":"linePartCov","hits":"1","order":"3594","possible_hits":"2",},
{"lineNum":"  297","line":"        round!(f, g, h, a, b, c, d, e, 0xc76c51a3, w[11], w[9], w[4], w[12]);","class":"linePartCov","hits":"1","order":"3595","possible_hits":"2",},
{"lineNum":"  298","line":"        round!(e, f, g, h, a, b, c, d, 0xd192e819, w[12], w[10], w[5], w[13]);","class":"linePartCov","hits":"1","order":"3596","possible_hits":"2",},
{"lineNum":"  299","line":"        round!(d, e, f, g, h, a, b, c, 0xd6990624, w[13], w[11], w[6], w[14]);","class":"linePartCov","hits":"1","order":"3597","possible_hits":"2",},
{"lineNum":"  300","line":"        round!(c, d, e, f, g, h, a, b, 0xf40e3585, w[14], w[12], w[7], w[15]);","class":"linePartCov","hits":"1","order":"3598","possible_hits":"2",},
{"lineNum":"  301","line":"        round!(b, c, d, e, f, g, h, a, 0x106aa070, w[15], w[13], w[8], w[0]);","class":"linePartCov","hits":"1","order":"3599","possible_hits":"2",},
{"lineNum":"  302","line":""},
{"lineNum":"  303","line":"        round!(a, b, c, d, e, f, g, h, 0x19a4c116, w[0], w[14], w[9], w[1]);","class":"linePartCov","hits":"1","order":"3600","possible_hits":"2",},
{"lineNum":"  304","line":"        round!(h, a, b, c, d, e, f, g, 0x1e376c08, w[1], w[15], w[10], w[2]);","class":"linePartCov","hits":"1","order":"3601","possible_hits":"2",},
{"lineNum":"  305","line":"        round!(g, h, a, b, c, d, e, f, 0x2748774c, w[2], w[0], w[11], w[3]);","class":"linePartCov","hits":"1","order":"3602","possible_hits":"2",},
{"lineNum":"  306","line":"        round!(f, g, h, a, b, c, d, e, 0x34b0bcb5, w[3], w[1], w[12], w[4]);","class":"linePartCov","hits":"1","order":"3603","possible_hits":"2",},
{"lineNum":"  307","line":"        round!(e, f, g, h, a, b, c, d, 0x391c0cb3, w[4], w[2], w[13], w[5]);","class":"linePartCov","hits":"1","order":"3604","possible_hits":"2",},
{"lineNum":"  308","line":"        round!(d, e, f, g, h, a, b, c, 0x4ed8aa4a, w[5], w[3], w[14], w[6]);","class":"linePartCov","hits":"1","order":"3605","possible_hits":"2",},
{"lineNum":"  309","line":"        round!(c, d, e, f, g, h, a, b, 0x5b9cca4f, w[6], w[4], w[15], w[7]);","class":"linePartCov","hits":"1","order":"3606","possible_hits":"2",},
{"lineNum":"  310","line":"        round!(b, c, d, e, f, g, h, a, 0x682e6ff3, w[7], w[5], w[0], w[8]);","class":"linePartCov","hits":"1","order":"3607","possible_hits":"2",},
{"lineNum":"  311","line":"        round!(a, b, c, d, e, f, g, h, 0x748f82ee, w[8], w[6], w[1], w[9]);","class":"linePartCov","hits":"1","order":"3608","possible_hits":"2",},
{"lineNum":"  312","line":"        round!(h, a, b, c, d, e, f, g, 0x78a5636f, w[9], w[7], w[2], w[10]);","class":"linePartCov","hits":"1","order":"3609","possible_hits":"2",},
{"lineNum":"  313","line":"        round!(g, h, a, b, c, d, e, f, 0x84c87814, w[10], w[8], w[3], w[11]);","class":"linePartCov","hits":"1","order":"3610","possible_hits":"2",},
{"lineNum":"  314","line":"        round!(f, g, h, a, b, c, d, e, 0x8cc70208, w[11], w[9], w[4], w[12]);","class":"linePartCov","hits":"1","order":"3611","possible_hits":"2",},
{"lineNum":"  315","line":"        round!(e, f, g, h, a, b, c, d, 0x90befffa, w[12], w[10], w[5], w[13]);","class":"linePartCov","hits":"1","order":"3612","possible_hits":"2",},
{"lineNum":"  316","line":"        round!(d, e, f, g, h, a, b, c, 0xa4506ceb, w[13], w[11], w[6], w[14]);","class":"linePartCov","hits":"1","order":"3613","possible_hits":"2",},
{"lineNum":"  317","line":"        round!(c, d, e, f, g, h, a, b, 0xbef9a3f7, w[14], w[12], w[7], w[15]);","class":"linePartCov","hits":"1","order":"3614","possible_hits":"2",},
{"lineNum":"  318","line":"        round!(b, c, d, e, f, g, h, a, 0xc67178f2, w[15], w[13], w[8], w[0]);","class":"linePartCov","hits":"1","order":"3615","possible_hits":"2",},
{"lineNum":"  319","line":""},
{"lineNum":"  320","line":"        self.h[0] = self.h[0].wrapping_add(a);","class":"lineCov","hits":"1","order":"3616","possible_hits":"1",},
{"lineNum":"  321","line":"        self.h[1] = self.h[1].wrapping_add(b);","class":"lineCov","hits":"1","order":"3617","possible_hits":"1",},
{"lineNum":"  322","line":"        self.h[2] = self.h[2].wrapping_add(c);","class":"lineCov","hits":"1","order":"3618","possible_hits":"1",},
{"lineNum":"  323","line":"        self.h[3] = self.h[3].wrapping_add(d);","class":"lineCov","hits":"1","order":"3619","possible_hits":"1",},
{"lineNum":"  324","line":"        self.h[4] = self.h[4].wrapping_add(e);","class":"lineCov","hits":"1","order":"3620","possible_hits":"1",},
{"lineNum":"  325","line":"        self.h[5] = self.h[5].wrapping_add(f);","class":"lineCov","hits":"1","order":"3621","possible_hits":"1",},
{"lineNum":"  326","line":"        self.h[6] = self.h[6].wrapping_add(g);","class":"lineCov","hits":"1","order":"3622","possible_hits":"1",},
{"lineNum":"  327","line":"        self.h[7] = self.h[7].wrapping_add(h);","class":"lineCov","hits":"1","order":"3623","possible_hits":"1",},
{"lineNum":"  328","line":"    }","class":"lineCov","hits":"1","order":"3624","possible_hits":"1",},
{"lineNum":"  329","line":"}"},
{"lineNum":"  330","line":""},
...
var header = { "command" : "lightning_invoice-99c93907235ac8b4", "date" : "2019-08-31 07:54:49", "instrumented" : 125, "covered" : 123,};
var merged_data = [];
