...
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"        fn deallocate(ptr: *mut [u8]) {","class":"lineCov","hits":"1","order":"5880","possible_hits":"1",},
{"lineNum":"   84","line":"            let _ = unsafe { Box::from_raw(ptr) };","class":"lineCov","hits":"1","order":"5881","possible_hits":"1",},
{"lineNum":"   85","line":"        }","class":"linePartCov","hits":"1","order":"5887","possible_hits":"2",},
{"lineNum":"   86","line":"    }"},
{"lineNum":"   87","line":""},
{"lineNum":"   88","line":"    impl<C: Context> Secp256k1<C> {"},
{"lineNum":"   89","line":"        /// Lets you create a context in a generic manner(sign/verify/all)"},
{"lineNum":"   90","line":"        pub fn gen_new() -> Secp256k1<C> {","class":"lineCov","hits":"1","order":"4010","possible_hits":"1",},
{"lineNum":"   91","line":"            let buf = vec![0u8; Self::preallocate_size_gen()].into_boxed_slice();","class":"lineCov","hits":"1","order":"4011","possible_hits":"1",},
{"lineNum":"   92","line":"            let ptr = Box::into_raw(buf);","class":"lineCov","hits":"1","order":"4100","possible_hits":"1",},
{"lineNum":"   93","line":"            Secp256k1 {","class":"lineCov","hits":"1","order":"5022","possible_hits":"1",},
{"lineNum":"   94","line":"                ctx: unsafe { ffi::secp256k1_context_preallocated_create(ptr as *mut c_void, C::FLAGS) },","class":"lineCov","hits":"1","order":"4120","possible_hits":"1",},
{"lineNum":"   95","line":"                phantom: PhantomData,"},
{"lineNum":"   96","line":"                buf: ptr,","class":"lineCov","hits":"1","order":"5021","possible_hits":"1",},
{"lineNum":"   97","line":"            }"},
{"lineNum":"   98","line":"        }","class":"linePartCov","hits":"1","order":"5023","possible_hits":"2",},
{"lineNum":"   99","line":"    }"},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"    impl Secp256k1<All> {"},
{"lineNum":"  102","line":"        /// Creates a new Secp256k1 context with all capabilities"},
{"lineNum":"  103","line":"        pub fn new() -> Secp256k1<All> {","class":"lineCov","hits":"1","order":"4008","possible_hits":"1",},
{"lineNum":"  104","line":"            Secp256k1::gen_new()","class":"lineCov","hits":"1","order":"4009","possible_hits":"1",},
{"lineNum":"  105","line":"        }","class":"linePartCov","hits":"1","order":"5024","possible_hits":"2",},
{"lineNum":"  106","line":"    }"},
{"lineNum":"  107","line":""},
...
var header = { "command" : "lightning_invoice-99c93907235ac8b4", "date" : "2019-08-31 07:54:49", "instrumented" : 13, "covered" : 13,};
var merged_data = [];
